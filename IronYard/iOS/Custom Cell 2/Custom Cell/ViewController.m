...
- (void)viewDidLoad {
    ...
    self.computers = @[@"Mac Plus", @"Bondi iMac", @"iMac Flat Panel", @"Mac Pro", @"Mac Mini", @"iMac Aluminium", @"PowerBook 100", @"PowerBook Duo", @"PowerBook G4", @"White MacBook", @"MacBook 13", @"MacBook Air"];
}
