...
- (void)viewDidLoad {
    ...
    [self.questions addObject:@[@"What is 7 + 7?", @"14", @"15", @"17", @"18", @"A"]];
    [self.questions addObject:@[@"What the capital of Spain?", @"London", @"Paris", @"Munich", @"Madrid", @"D"]];
    [self.questions addObject:@[@"From what is the cider made?", @"Oranges", @"Apples", @"Grapes", @"Cherries", @"B"]];
...
- (IBAction)answerButton:(id)sender {
    ...
    if ([title isEqualToString:currentQuestionSet[5]]) {
        ...
        self.resultLabel.text = @"Sorry Wrong";
