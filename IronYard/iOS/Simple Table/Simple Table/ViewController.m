...
- (void)viewDidLoad {
    ...
    self.listData = @[@"Mac Plus", @"Bondi iMac", @"iMac Flat Panel", @"Mac Pro", @"Mac Mini", @"iMac Aluminium", @"PowerBook 100", @"PowerBook Duo", @"PowerBook G4", @"White MacBook", @"MacBook 13", @"MacBook Air"];
}
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIAlertController *myAlert = [UIAlertController alertControllerWithTitle:@"Rw Selected" message:message preferredStyle:UIAlertControllerStyleAlert];
